      ...
      <Card className="p-6 bg-gradient-card border-0 shadow-soft">
        ...
        <div className="space-y-4">
          <div className="flex items-start space-x-3 p-3 bg-muted/30 rounded-lg">
            ...
            <div>
              <p className="text-sm text-foreground">Resumes are observed to secure, on average, a score of <span className="font-semibold">74</span> on the VMock platform</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3 p-3 bg-muted/30 rounded-lg">
            ...
            <div>
              <p className="text-sm text-foreground"><span className="font-semibold">16</span> is the surge in score observed for users once they incorporate VMock feedback</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3 p-3 bg-muted/30 rounded-lg">
            ...
            <div>
              <p className="text-sm text-foreground">Analytical skill is the highest reflected skill in resumes of VMock users</p>
            </div>
          </div>
