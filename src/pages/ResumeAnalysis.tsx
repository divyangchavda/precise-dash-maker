...
const ResumeAnalysis = () => {
  ...
  const metrics = [
    { label: "Impact", score: 28, maxScore: 40, color: "text-success" },
    { label: "Presentation", score: 23, maxScore: 30, color: "text-success" },
    { label: "Competencies", score: 17, maxScore: 30, color: "text-warning" }
  ];
      ...
      <div className="flex">
        ...
        <div className="flex-1 p-6 space-y-6">
          ...
          <Card className="p-6 bg-gradient-card border-0 shadow-moderate">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-xl font-semibold text-foreground">Divyang Chavda Resume</h2>
                <p className="text-sm text-muted-foreground">Uploaded - August 9th 2025 at 10:53 PM</p>
              </div>
          ...
          <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex items-center justify-center space-x-8">
                ...
                <div className="relative w-48 h-48">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-5xl font-bold text-warning">{score}</span>
                  </div>
                </div>
            ...
            <Card className="p-6 bg-gradient-card border-0 shadow-moderate">
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold text-success mb-2">You are on track!</h3>
